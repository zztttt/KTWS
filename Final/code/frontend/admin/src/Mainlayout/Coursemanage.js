...
class EditableTable extends React.Component {
  constructor(props) {
    ...
    this.serverRequest = $.get("/admingetcourseinfo",function(data){
        console.log(data);
        this.setState({
  ...
  handleDelete = (record) => {
      ...
      var course_id = deleteData.course_id;
      this.serverRequest = $.post("/admindeletecourseinfo",{ course_id:course_id },function(data){
          console.log(data);
  }.bind(this));
  }
  ...
  save(form, key) {
    form.validateFields((error, row) => {
      ...
      if (index > -1) {
        ...
        console.log(newData);
        var course = newData[index];
        console.log(course);
        var course_id = course.course_id;
        var username = course.username;
        var classroom_id = course.classroom_id;
        var total = course.total;
        var time = course.time;
          this.serverRequest = $.post("/admineditcourseinfo",{ course_id:course_id, username:username, classroom_id:classroom_id, total:total, time:time},function(data){
              console.log(data);
          }.bind(this));
